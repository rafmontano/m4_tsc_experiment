...
def get_sktime_models(model_num: int = -1, n_jobs=1):
    """
    ...
    models = {
     ...
     #   ),
        "DTW":  KNeighborsTimeSeriesClassifier(
                ...
                n_jobs=n_jobs,  # keep memory stable (increase later if safe)
        ),
